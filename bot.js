...
"token": "MjM2NTQwNTg0NjAzNDE4NjI1.XgId2g.42nRxc_1W0_-w-3LSsvKdEZRvBU", //EL PIOU AHAHAHAHH 
"userid": "236540584603418625",


"NDUxMzA2NTMxMjA0NDk3NDA4.XgKJxg.0KrzABFrRtT6sXR7zOzIAsV25Og" // Mister Green
451306531204497408
...
case "cc":
    //transfère bddocta -> bdd3
start()


for (let index = 0; index < Object.keys(bddocta).length; index++) {

    
    
if (!bdd3[Object.keys(bddocta)[index]]){
    bdd3[Object.keys(bddocta)[index]] = {}} 
    



console.log("Essai numéro: "+index)
}

fs.writeFileSync("./bdd3.json", JSON.stringify(bdd3))
fin()
break;
